...
{
    public static bool ShowAnimatedBackgroundProps(AnimatedBackground ab, CommandHistory cmd, RaylibCanvas? canvas, string? assetDir)
    {
        bool propChanged = false;
        if (ImGui.CollapsingHeader("Gfx"))
            propChanged |= ShowProperties(ab.Gfx, cmd, canvas, assetDir);
